...
public class StringUtils {
    ...
    public static String hideMidString(String str) {
        if (!isEmpty(str)) {
            if (RegexTool.regexEmailAddress(str)) {
                String _endString = str.substring(str.indexOf("@"), str.length());
                String preString = str.substring(0, str.indexOf("@"));
                if (preString.length() >= 3) {
                    String pre_string = preString.substring(0, 2);
                    String end_string = str.substring(preString.length() - 3, preString.length());
                    return pre_string + "***" + end_string + _endString;
                } else {
                    System.out.println(preString + "***" + preString + _endString);
                    return preString + "***" + preString + _endString;
                }
     ...
     * @param expected
     * @return
     * @see com.util.ObjectUtils#isEquals(Object, Object)
     */
