...
public class ButterKnifePage extends BaseFragment {
    ...
    protected void click() {
        ...
        RxView.clickEvents(btThrottleFirst)
                ...
                .subscribe(new Action1<Long>() {
                    ...
                    public void call(Long aLong) {
                        LogUtil.info(ButterKnifePage.class, "clickEvents  ---> : " + aLong);
                    }
                });
        ...
        RxView.clicks(btThrottleFirst)
                ...
                .subscribe(new Action1<Long>() {
                    @Override
                    public void call(Long aLong) {
                        LogUtil.info(ButterKnifePage.class, "clicks ---> : " + aLong);
                    }
                });
        //-------  防止多次点击  end  ---------------//
...
//                })
                .doOnSubscribe(new Action0() {
                    @Override
                    public void call() {
                        LogUtil.info(ButterKnifePage.class, "doOnSubscribe  ");
                    }
                })
                .doOnNext(new Action1<String>() {
                    @Override
                    public void call(String s) {
                        LogUtil.info(ButterKnifePage.class, "doOnNext" + s);
                    }
                })
                .subscribe(new Action1<String>() {
                    @Override
                    public void call(String s) {
                        LogUtil.info(ButterKnifePage.class, "input --->" + s);
                    }
                });
